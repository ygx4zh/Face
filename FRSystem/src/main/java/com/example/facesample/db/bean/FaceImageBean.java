...
public class FaceImageBean {
    ...
    @Generated(hash = 466129202)
    public FaceImageBean(String fname, String face_token, String face_feature,
            String path, String extra, int type) {
        this.fname = fname;
    ...
    public void setFace_feature(String face_feaature) {
        this.face_feature = face_feaature;
    }
}
